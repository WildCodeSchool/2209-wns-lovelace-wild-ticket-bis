...
export type MyProfileQueryQuery = { __typename?: 'Query', myProfile: { __typename?: 'AppUser', id: string, emailAddress: string, firstName: string, lastName: string } };
...
export type FlowsQuery = { __typename?: 'Query', myProfile: { __typename?: 'AppUser', flows: Array<{ __typename?: 'Flow', id: string, flowName: string, tickets: Array<{ __typename?: 'Ticket', id: string, date: any, orderNumber: number, status: string, isTrash: boolean }> }> } };
