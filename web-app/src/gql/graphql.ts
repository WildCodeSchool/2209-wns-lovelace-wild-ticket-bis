...
export type MyprofileQuery = { __typename?: 'Query', myProfile: { __typename?: 'AppUser', id: string, firstName: string, flows: Array<{ __typename?: 'Flow', flowName: string, id: string, calculateTicketCounts: { __typename?: 'NumberOfTickets', incident?: number | null, nonScanned?: number | null, validate?: number | null, waiting?: number | null }, tickets: Array<{ __typename?: 'Ticket', date: any, id: string, isTrash: boolean, status: string }> }> } };
